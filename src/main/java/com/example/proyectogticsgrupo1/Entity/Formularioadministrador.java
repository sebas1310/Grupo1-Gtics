...
public class Formularioadministrador {
    ...
    @Id
    @Column(name = "idformularioadministrador")
    private int idformularioadministrador;
    @Basic
    @Column(name = "nombres")
    ...
    public int getIdformularioadministrador() {
        return idformularioadministrador;
    }

    public void setIdformularioadministrador(int idformularioadministrador) {
        this.idformularioadministrador = idformularioadministrador;
    }
    ...
    public boolean equals(Object o) {
        ...
        Formularioadministrador that = (Formularioadministrador) o;

        if (idformularioadministrador != that.idformularioadministrador) return false;
    ...
    @Override
    public int hashCode() {
        int result = idformularioadministrador;
