...
public class GMailer {
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
            throws IOException {
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, new InputStreamReader(GMailer.class.getResourceAsStream("/client_secret_956641435094-0qfuaivakos51vfaoj42oi4kvnjrdsqk.apps.googleusercontent.com.json")));
        ...
        LocalServerReceiver receiver = new LocalServerReceiver.Builder().setHost("0.0.0.0").setPort(8888).build();
